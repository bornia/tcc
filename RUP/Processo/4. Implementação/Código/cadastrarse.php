...
if(!empty($_SESSION)) {
  if($_GET['emailRef'] == $_SESSION['email']) {
    require_once ('reqs/classes/db.class.php');
    ...
    $usuario_permissao = $_GET['permissao'];

    $sql = "INSERT INTO usuario_pertence_grupo(grupo_id_ref, usuario_id_ref, permissao) VALUES ($grupo_id, $usuario_id, $usuario_permissao);";
    ...
    if(!$res) {
      echo
        "<div class='alert alert-" . "danger" . "' role='alert'>" .
          ...
          "</button>" .
          "<div> " . "Não foi possível associar o usuário logado com o grupo que se deseja participar." . " </div>" .
        "</div>";
    }
